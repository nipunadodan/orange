    ...
    <div class="modal-dialog modal-dialog-centered border-0" role="document">
        <div class="modal-content border-0 ">
            ...
            <div class="modal-footer border-0 p-0 mt-3">
                <button type="button" id="response-modal-okay" class="btn btn-light text-small text-uppercase w-100 rounded-0 rounded-bottom py-3 m-0" data-bs-dismiss="modal">Okay</button>
            </div>
        </div>
    </div>
</div>
